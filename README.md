## This is to test build [RiMusic](https://github.com/fast4x/RiMusic) with Kotlin 2.0, but aparently the build process stuck on Task :app:compileFossDebugKotlin.

## Kotlin 2.0.20 fixed it.
